...
import faq1 from "../../assets/PNG's/faq1.png";
import faq2 from "../../assets/PNG's/faq2.png";
          ...
          <Grid item md={6}>
            <div className={classes.container}>
              ...
              <h4 className={classes.content}>
                We know what our customers ask us many times. By searching this
                part, you can find almost all solutions you need to solve.
              </h4>
            </div>
              ...
              {accordionData.map((accordion, index) => (
                <React.Fragment key={accordion.id}>
                  <Grid item md={1} className={classes.number}>
                    <h4 style={{ fontSize: "28px", color: "#8C8C8C", marginTop: "30px" }}>

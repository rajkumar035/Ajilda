...
const ProductCard = (props) => {
  ...
  return (
    <Box onClick={() => {
       ...
       width={"100%"} component={"div"} sx={{ opacity: status === "Sold out" ? "80%" : "100%" }}>
      <Box component={"div"} position={"relative"}>
        <Box component={"img"} src={img} className={`img-cover ${classes.bannerImg}`} />
        {status === "Sold out" ? null : (
          <Chip
      ...
      <Box component={"div"} className={classes.flexColumn} gap={"16px"} padding={"10px 0px"}>
        ...
        <Box component={"div"} sx={{ display: "flex", gap: "8px" }}>
          ...
          <Box component={"div"} sx={{ display: "flex", gap: "3px" }}>
            ...
            <Typography component={"label"} variant="smallThin" color={"#595959"}>
        ...
        <Button
          ...
          variant="contained"
          disabled={status === "Sold out" ? true : false}
          color="primary"
          fullWidth
          endIcon={
        ...
        >
          {status === "Sold out" ? "Sold out" : "Add to cart"}
        </Button>
      </Box>
    </Box>
  );
